...
MANUAL_UID = "YOUR_BOT_UID_HERE"
MANUAL_PASS = "YOUR_BOT_PASSWORD_HERE"
# ==========================================

# --- VERSION CONFIG (UPDATED FOR DEC 2025) ---
CURRENT_OB_VERSION = "OB56" 
UNITY_VERSION = "2018.4.11f1"
MSDK_VERSION = "GarenaMSDK/4.0.22" # Updated MSDK
...
class FF_ONE_TIME_RUNNER:
    ...
    def execute(self, target_uid):
        ...
        # FIX: Updated User-Agent
        headers_guest = {"User-Agent": MSDK_VERSION, "Content-Type": "application/x-www-form-urlencoded"}
        ...
        if 'access_token' not in r: 
            return False, f"Guest Login Failed. Check UID/Pass. Resp: {str(r)}"
        ...
        # FIX: Updated ReleaseVersion to OB56 (Estimated for Dec 2025)
        headers = {'X-Unity-Version': UNITY_VERSION, 'ReleaseVersion': CURRENT_OB_VERSION, 'User-Agent': 'Dalvik/2.1.0', 'Content-Type': 'application/x-www-form-urlencoded'}
        ...
        try:
            ...
            return False, "Failed to get Server IP (GetLoginData parse error)"
